...
float _prim_test_rectangle_vertices[] = {
        ...
        -0.5f, -0.5f, -0.5f,    1.2f, 0.2f, 0.2f,   0,0,    -0.33,-0.33,-0.33, //0
        0.5f, -0.5f, -0.5f, 0.2f, 1.2f, 0.2f,       0,0,    0.33,-0.33,-0.33, //1
        -0.5f, 0.5f, -0.5f, 0.2f, 0.2f, 1.2f,       0,0,    -0.33,0.33,-0.33,//2
        0.5f, 0.5f, -0.5f, 1.2f, 0.2f, 0.2f,        0,0,    0.33,-0.33,-0.33, //3


        -0.5f, -0.5f, 0.5f, 0.2f, 0.2f, 0.2f,       0,0,    -0.33,-0.33,0.33,//4
       0.5f, -0.5f, 0.5f, 0.2f, 0.2f, 0.2f,         0,0,    0.33,-0.33,0.33,//5
        -0.5f, 0.5f, 0.5f, 0.2f, 0.2f, 0.2f,        0,0,    -0.33,0.33,0.33, //6
        0.5f, 0.5f, 0.5f, 0.2f, 0.2f, 0.2f,         0,0,    0.33,0.33,0.33, //7
};
